...
public class GGStringsTest {
    ...
    public void leftPad() {
        ...
        assertThat(GGStrings.leftPad("a", 100),
                equalTo("                                                                                                   a"));
        ...
        assertThat(GGStrings.leftPad("Car", 100),
                equalTo("                                                                                                 Car"));
    ...
    public void rightPad() {
        ...
        assertThat(GGStrings.rightPad("a", 100),
                equalTo("a                                                                                                   "));
        ...
        assertThat(GGStrings.rightPad("Car", 100),
                equalTo("Car                                                                                                 "));
    ...
    public void center() {
        ...
        assertThat(GGStrings.center("Car", 100),
                equalTo("                                                Car                                                 "));
    ...
    public void isBlank() {
        ...
        assertThat(GGStrings.isBlank(null), equalTo(true));
        assertThat(GGStrings.isBlank(""), equalTo(true));
        assertThat(GGStrings.isBlank(" "), equalTo(true));
        assertThat(GGStrings.isBlank("\t"), equalTo(true));
        assertThat(GGStrings.isBlank(" \t"), equalTo(true));

        assertThat(GGStrings.isBlank(" a"), equalTo(false));
        assertThat(GGStrings.isBlank("a "), equalTo(false));
    }
    ...
    public void isNotBlank() {
        ...
        assertThat(GGStrings.isNotBlank(null), equalTo(false));
        assertThat(GGStrings.isNotBlank(""), equalTo(false));
        assertThat(GGStrings.isNotBlank(" "), equalTo(false));
        assertThat(GGStrings.isNotBlank("\t"), equalTo(false));
        assertThat(GGStrings.isNotBlank(" \t"), equalTo(false));

        assertThat(GGStrings.isNotBlank(" a"), equalTo(true));
        assertThat(GGStrings.isNotBlank("a "), equalTo(true));
    }
