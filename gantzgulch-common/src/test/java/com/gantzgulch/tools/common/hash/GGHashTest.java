...
public class GGHashTest {
	...
	public void sha256() {
		...
		final byte[] hash = GGHash.SHA_256.hash(testBytes);
	...
	public void sha384() {
		...
		final byte[] hash = GGHash.SHA_384.hash(testBytes);
	...
	public void sha512() {
		...
		final byte[] hash = GGHash.SHA_512.hash(testBytes);
	...
	public void sha256Hex() {
		...
		final String hash = GGHash.SHA_256.hashToHexString(testBytes);
	...
	public void sha384Hex() {
		...
		final String hash = GGHash.SHA_384.hashToHexString(testBytes);
	...
	public void sha512Hex() {
		...
		final String hash = GGHash.SHA_512.hashToHexString(testBytes);
    ...
    public void sha256Base64() {
        ...
        final String hash = GGHash.SHA_256.hashToBase64String(testBytes);
	...
	public void sha256Base64Url() {
		...
		final String hash = GGHash.SHA_256.hashToBase64UrlString(testBytes);
	...
	public void sha384Base64() {
		...
		final String hash = GGHash.SHA_384.hashToBase64String(testBytes);
    ...
    public void sha384Base64Url() {
        ...
        final String hash = GGHash.SHA_384.hashToBase64UrlString(testBytes);
	...
	public void sha512Base64() {
		...
		final String hash = GGHash.SHA_512.hashToBase64String(testBytes);
    ...
    public void sha512Base64Url() {
        ...
        final String hash = GGHash.SHA_512.hashToBase64UrlString(testBytes);
