...
public class HashTest {
	...
	public void sha256() {
		...
		final byte[] testBytes = Strings.toBytes("abcdefghijklmnopqrstuvwxyz");

		final byte[] expectedHash = Bytes.fromHex("71c480df93d6ae2f1efad1447c66c9525e316218cf51fc8d9ed832f2daf18b73");
		
		final byte[] hash = Hash.sha256(testBytes);
	...
	public void sha384() {
		...
		final byte[] expectedHash = Bytes.fromHex("feb67349df3db6f5924815d6c3dc133f091809213731fe5c7b5f4999e463479ff2877f5f2936fa63bb43784b12f3ebb4");
		
		final byte[] hash = Hash.sha384(testBytes);
	...
	public void sha512() {
		...
		final byte[] expectedHash = Bytes.fromHex("4DBFF86CC2CA1BAE1E16468A05CB9881C97F1753BCE3619034898FAA1AABE429955A1BF8EC483D7421FE3C1646613A59ED5441FB0F321389F77F48A879C7B1F1");
		
		final byte[] hash = Hash.sha512(testBytes);
	...
	public void sha256Hex() {
		...
		final String hash = Hash.sha256Hex(testBytes);
	...
	public void sha384Hex() {
		...
		final String hash = Hash.sha384Hex(testBytes);
	...
	public void sha512Hex() {
		...
		final String hash = Hash.sha512Hex(testBytes);
	...
	public void sha256Base64() {
		...
		final String hash = Hash.sha256Base64(testBytes);
	...
	public void sha384Base64() {
		...
		final String hash = Hash.sha384Base64(testBytes);
	...
	public void sha512Base64() {
		...
		final String hash = Hash.sha512Base64(testBytes);
